...
export const en: Translations = {
  ...
  profile: {
    subtitle: "Software Engineer • Security & Identity • Elixir/Phoenix • Fintech • Ruby • Go",
    bioSegments: [
      { text: "Software Engineer", highlight: true },
      { text: " focused on ", highlight: false },
      { text: "Distributed Backend, Fintech, and Security", highlight: true },
      { text: ". Building ", highlight: false },
      { text: "resilient and scalable systems with Elixir/OTP, Ruby, and Go", highlight: true },
      { text: " in a ", highlight: false },
      { text: "Banking as a Service", highlight: true },
      { text: " environment. Working at the intersection of ", highlight: false },
  ...
  links: {
    tagline: "Software Engineer • Elixir • Ruby • Fintech",
    portfolio: "Portfolio",
    blog: "Blog",
    linkedin: "LinkedIn",
    github: "GitHub",
