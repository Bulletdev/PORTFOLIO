...
export const en: Translations = {
  ...
  profile: {
    ...
    bioSegments: [
      ...
      { text: "high-performance development (Java/Spring/Ruby)", highlight: true },
      { text: " and ", highlight: false },
      { text: "Offensive Cybersecurity", highlight: true },
      { text: ". Building ", highlight: false },
      { text: "resilient and Secure-by-Design architectures", highlight: true },
      { text: ", advocating for best practices and promoting ", highlight: false },
