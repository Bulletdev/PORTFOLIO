...
export const pt: Translations = {
  ...
  profile: {
    subtitle: "Engenheiro de Software • Segurança & Identidade • Elixir/Phoenix • Fintech • Ruby • Go",
    bioSegments: [
      { text: "Engenheiro de Software", highlight: true },
      { text: " focado em ", highlight: false },
      { text: "Backend Distribuído, Fintech e Segurança", highlight: true },
      { text: ". Construindo sistemas ", highlight: false },
      { text: "resilientes e escaláveis com Elixir/OTP, Ruby e Go", highlight: true },
      { text: " em ambiente de ", highlight: false },
      { text: "Banking as a Service", highlight: true },
      { text: ". Atuando na interseção entre ", highlight: false },
      { text: "engenharia de alta performance e Segurança & Identidade", highlight: true },
      { text: ", promovendo boas práticas e ", highlight: false },
