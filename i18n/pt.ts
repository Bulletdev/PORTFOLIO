...
export const pt: Translations = {
  ...
  profile: {
    ...
    bioSegments: [
      ...
      { text: "desenvolvimento de alta performance (Java/Spring/Ruby)", highlight: true },
      { text: " e ", highlight: false },
      { text: "Cibersegurança Ofensiva", highlight: true },
      { text: ". Construindo arquiteturas ", highlight: false },
      { text: "resilientes e Secure-by-Design", highlight: true },
      { text: ", defendendo boas práticas na comunidade e promovendo ", highlight: false },
