...
export default function Navigation(): ReactNode {
  ...
  return (
    <nav className="w-screen">
      <div
        className={`flex flex-col bg-spotify-light-dark max-md:mx-4 max-md:mt-4 mx-32 mt-4 p-2 rounded-full ${mobile ? "max-md:rounded-t-xl max-md:rounded-b-none" : "max-md:rounded-xl"}`}
      >
          ...
          <Link href="/" className="flex gap-2 text-3xl font-bold items-center">
            ...
            <TypewriterEffect
              words={[
                ...
                { text: "Bullet", className: "text-3xl" },
              ]}
